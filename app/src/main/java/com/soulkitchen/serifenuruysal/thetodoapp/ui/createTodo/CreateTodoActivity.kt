package com.soulkitchen.serifenuruysal.thetodoapp.ui.createTodo
...
import com.soulkitchen.serifenuruysal.thetodoapp.utils.Constants
...
class CreateTodoActivity : AppCompatActivity() {
    ...
    private fun saveTodo() {
        if (validateFields()) {
            ...
            val todo =
                TodoRecord(id = id, title = et_todo_title.text.toString(), content = et_todo_content.text.toString())
            val intent = Intent()
